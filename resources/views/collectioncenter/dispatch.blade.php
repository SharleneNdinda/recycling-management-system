...
<body>
 <div class="container">
         ...
         <div class="card featured">
            <div class="card-header"> New Dispatch
             </div>
                <form  method="POST" action="{{ route('order.create') }}">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"> Your Order Has Been dispatched and Will Be Collected Soon   </h5>
                        <p> Please make sure the package is ready for pickup</p>
