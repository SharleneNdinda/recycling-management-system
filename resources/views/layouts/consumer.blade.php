    ...
    <div class="sidebar">
        ...
        <ul class="nav-list">
            <li>
             ...
             <li>
                <a href="{{route('consumer.deposit.view')}}">
                 <i class='bx bx-down-arrow-alt' ></i>
                    <span class="links-name">Deposits</span>
                </a>
                <!-- <span class="tooltip">Dashboard</span> -->
            </li>
             <li>
                <a href="{{route('consumer.map.view')}}">
                  <i class='bx bx-map-alt'></i>
                    <span class="links-name">Find A Center</span>
                </a>
                <!-- <span class="tooltip">Dashboard</span> -->
            </li>
             <li>
                <a href=" {{route('plantoffers.view')}}">
                   <i class='bx bx-coin'></i>
                    <span class="links-name">Green Points</span>
                </a>
                <!-- <span class="tooltip">Dashboard</span> -->
            </li>
